...
exports.init = function (mockup_exports) {
    ...
    mockup_exports.query = function(val){
        var response;
        var tagValue = mockupHelper.genDTO('TsdbTagValue',{'tag' : ''});

        val.datasets = [mockupHelper.genDTO('TsdbDataSet', {})];
        response = mockupHelper.genResponse(undefined, val.datasets);
        return response;
    }
};
