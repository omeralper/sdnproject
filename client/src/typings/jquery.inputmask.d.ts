...
interface JQueryInputMaskOptions {
    ...
    repeat?: string; //repetitions of the mask: * ~ forever, otherwise specify an integer
...
interface inputMaskStatic {
    ...
    extendDefinitions : (definition) => void;
    extendAliases : (alias)=> void;
}
...
declare var Inputmask: inputMaskStatic;
