...
interface I18nextStatic {
	...
	init(options?: I18nextOptions, callback?: (err: any, t: any) => void): JQueryDeferred<any>;
	lng(): string;
	...
	t(key: string, options?: (I18nextOptions | any)): string;
	translate(key: string, options?: (I18nextOptions | any)): string;
}
