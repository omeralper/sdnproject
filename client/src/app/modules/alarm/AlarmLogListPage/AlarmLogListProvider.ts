...
export class AlarmLogListProvider {
    ...
    getDataTableOptions(page: IAlarmLogConsumer) {
        ...
        return {
            columns: [
                ...
                {title: page.ft('time'), width: '19.5%', orderable: true, type: 'date', name: 'time', searchable: true, className:"dt-center hidden-tds" },
                {title: page.ft('type'), width: '8%', orderable: true, type: 'num', name: 'type', searchable: true, className:"dt-center", visible : page.pageType == UI_PAGE_TYPE.PAGE },
                {title: page.ft('severity_short'), width: '9%', orderable: true, type: 'num', name: 'severity', searchable: true, className:"dt-center" },
                {title: page.ft('status_short'), width: '9%', orderable: true, type: 'num', name: 'alarmStatus', searchable: true, className: "dt-center" },
                {title: page.ft('id_short'),tooltip: page.ft('id'), width: '5%', orderable: true, type: 'number', name: 'id', searchable: true },
                {title: page.ft('name'), width: '13.5%', orderable: true, type: 'string', name: 'name', searchable: true, className:"hidden-tds" },
                {
                ...
                {title: page.ft('vtnName'), width: '10%', orderable: true, type: 'string', name: 'vtnName', searchable: true},
                {title: page.ft('resource'), width: '9%', orderable: true, type: 'string', name: 'resource', searchable: true, className:"hidden-tds"},
                {title: page.ft('correctionAction'), width: '9%', orderable: true, type: 'string', name: 'correctionAction', searchable: true, className:"hidden-tds"},
                // {
    ...
    public getAlarmName(value:string,isReverse:boolean=false):string {
        if (isReverse){
            ...
            return this.baseServices.uiHelper.renderIcon("ALARM_NAMES", value, { noIcon: true });
        }
    }
