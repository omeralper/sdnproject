...
import {CONTROLLERNODETYPE} from "../../../../../swagger/CONTROLLERNODETYPE";
    ...
    makeDataTableRequest(requestOptions: any, data: any, callback: (data: any) => void) {
        ...
        let request = this.baseServices.apiHelper.genRequest({
            data: this.baseServices.apiHelper.genDTO({
                nodeType: this.controller.type == CONTROLLERNODETYPE.CONTROLLER ? 'CONTROLLER' : 'API_CORE',
                nodeId: this.controller.nmNodeId ? this.controller.nmNodeId : this.controller.controllerNodeId,
                nodeVersion: "1.1.0"
            }, true)
        });
        ...
        this.configApi
            .configModuleNodeConfigListPOST(<ModuleNodeConfigListRequest>request, true)
            .subscribe(
                (res) => {
