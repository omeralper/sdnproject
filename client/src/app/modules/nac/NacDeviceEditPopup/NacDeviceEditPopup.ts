...
import {NACDEVICESTATUS} from "../../../swagger/NACDEVICESTATUS";
...
export class NacDeviceEditPopup extends BasePopupEditPage<NacDeviceDTO> implements OnInit, AfterViewInit, OnDestroy {
	...
	public statuses = EnumHelper.getNames(NACDEVICESTATUS);
	...
	constructor(public changeDetector: ChangeDetectorRef,
		...
		this.data.status = this.data.status || NACDEVICESTATUS.ACTIVE;
