        ...
        this.mvtnApi
            ...
            .subscribe(
                (res) => {
                    ...
                    //     this.virtualNetworks.unshift({name: this.t('labels.no_mvtn')});
                    // }
                    // if (this.isNewItem) {
                    //     this.virtualNetwork = this.virtualNetworks[0];
                    // } else {
                    //     for (let i = 0; i < this.virtualNetworks.length; i++) {
                    //         if (this.virtualNetworks[i].id == this.data.mvtnId) {
                    //             this.virtualNetwork = this.virtualNetworks[i];
                    //             i = this.virtualNetworks.length + 1;
                    //         } else if (i == (this.virtualNetworks.length - 1)) {
                    //             this.virtualNetwork = this.virtualNetworks[0];
                    //         }
                    //     }
                    // }
