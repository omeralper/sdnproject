    ...
    getDataTableOptions() {
        return {
            columns: [
                ...
                {title: this.ft('groupType'), width: '5%', orderable: true, type: 'string', name: 'groupType',className:"dt-center" },
                {title: this.ft('name'), width: '10%', orderable: true, type: 'string', name: 'name'},
                {title: this.ft('userNumber_short'), tooltip: this.ft('userNumber'), width: '5%', orderable: true, type: 'number', name: 'userNumber', className:"dt-center"  },
                ...
                {title: this.ft('allowAutoBYOD'), width: '10%', orderable: true, type: 'string', name: 'allowAutoBYOD', className:"dt-center" },
                ...
                {title: this.ft('priority'), width: '10%', orderable: true, type: 'number', name: 'priority'},
                {
