...
export class TopologyEventsListenerFactory {
    ...
    constructor(@Inject('ISessionInvalidator') public sessionInvalidator: ISessionInvalidator, public sessionManager: SessionManager, public baseServices: PageServices) {
