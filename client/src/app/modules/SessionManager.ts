...
export class SessionManager {
    ...
    parseSettings(settings: object) {
        ...
        try {
            this.isLdapEnabled = is.existy(settings["isLdapEnabled"]) ? JSON.parse(settings["isLdapEnabled"].toString().toLowerCase()) : false;
        } catch (e) {
            console.error(e);
