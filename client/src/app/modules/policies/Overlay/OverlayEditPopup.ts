...
export class OverlayEditPopup extends BasePopupEditPage<AccessPolicyDTO> implements OnInit, AfterViewInit, OnDestroy {
	...
	save() {
		...
		//creation time of rules shouldn't change if they got it, else it is newly created. [MLAT-3966]
		this.rule.creationTime = this.rule.creationTime ? this.rule.creationTime : new Date();
