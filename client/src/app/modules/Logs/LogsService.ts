...
export class LogProvider {
    ...
    getAllColumns(page: IAlarmLogConsumer){
        return [
            ...
            {title: page.ft('status'), width: '5%', orderable: false, type: 'num', name: 'status', searchable: true, className:"dt-center", visible : page.pageType == UI_PAGE_TYPE.PAGE },
            ...
            {title: page.ft('sourceIP'), width: '10%', orderable: false, type: 'string', name: 'sourceIP', searchable: true},
            {title: page.ft('destinationIP'), width: '10%', orderable: true, type: 'string', name: 'destinationIP', searchable: true },
            {title: page.ft('sourceMAC'), width: '10%', orderable: false, type: 'string', name: 'sourceMAC', searchable: true},
            ...
            {title: page.ft('data'), width: '8%', orderable: true, type: 'string', name: 'data', searchable: true, className:"dt-center"}
        ];
    }
