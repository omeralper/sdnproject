...
export class LoginPageCode extends BasePage implements OnInit, OnDestroy, OnChanges, AfterViewInit {
    ...
    constructor(public route: ActivatedRoute, public injector: Injector, public changeDetector: ChangeDetectorRef, public router: Router, baseServices: PageServices, elementRef: ElementRef, public zone: NgZone, public wanDomainApi: WANDOMAINApi) {
                    ...
                    .subscribe((res: WanDomainResponse) => {
                        if (this.baseServices.uiHelper.processResponse(res)) {
                            if (res.data && res.data.name) { //subdomain'de olduğumuzu gösterir
                                ...
                                this.router.navigate(['/topology/view'],  {queryParams: {action: UI_TOPOLOGY_ACTION.NEW_SUPER_TOPOLOGY, domainId: ""} });
                            }
                        }else{
