...
export class PathListPopup extends BasePopupDataTablesPage<any,PathDTO> implements OnInit, AfterViewInit, OnDestroy {
    ...
    getDataTableOptions() {
        ...
        return {
            columns: [
                {title: this.ft('state'), width: '5%', orderable: true, type: 'string', className: 'dt-center', name: 'state'},
                ...
                {title: this.ft('protocol'), width: '5%', orderable: true, type: 'string', className: 'dt-center', name: 'protocol'},

                {title: this.ft('srcDeviceId'), width: '15%', orderable: true, type: 'string', className: 'dt-center', name: 'srcDeviceId'},
                {title: this.ft('srcHostId'), width: '15%', orderable: true, type: 'string', className: 'dt-center', name: 'srcHostId'},
                {title: this.ft('srcPort'), width: '8%', orderable: true, type: 'number', className: 'dt-center', name: 'srcPort'},

                {title: this.ft('dstDeviceId'), width: '15%', orderable: true, type: 'string', className: 'dt-center', name: 'dstDeviceId'},
                {title: this.ft('dstHostId'), width: '15%', orderable: true, type: 'string', className: 'dt-center', name: 'dstHostId'},
                {title: this.ft('dstPort'), width: '8%', orderable: true, type: 'number', className: 'dt-center', name: 'dstPort'},

                {title: this.ft('links_short'), tooltip: this.ft('links'), width: '4%', orderable: true, type: 'number', className: 'dt-center', name: 'links'},
                {
