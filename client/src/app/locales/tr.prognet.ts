    ...
    "translation": {
        "common": {
            ...
            "buttons": {
                ...
                "toggle_physical_button_title": "Fiziksel/Sanal Ağı Göster"
            },
            "fields": {
                "actions": "İşlemler",
            ...
            "messages": {
                ...
                "validation_error": "Form verileri hatalı veya eksik, lütfen kontrol ediniz.",
	               "wan_selection_error": "Lütfen en az 2 yerel alan seçiniz",
                "validation": {
                ...
                "json_parse_error":"JSON verisi hatalı lütfen düzeltip tekrar deneyiniz.",
	        ...
	        "monitor": {
            	"addMonitor" : "Yeni bir gösterge ekle"
	        }
        },
        "enums": {
            "BOOLEAN": {
            ...
            "NACDEVICESTATUS": {
                ACTIVE: {icon: 'fa fa-check-circle', color: 'green-jungle', title: 'Aktif'},
                QUARANTINED: {icon: 'fa fa-medkit', color: 'red-mint', title: 'Karantinada'}
            },
            "NACENTITYTYPE": {
            ...
            "HOSTTYPE": {
                ...
                SFC_FIREWALL: {icon: 'fa fa-shield', color: 'yellow-casablanca', title: 'SFC Firewall', fontCode: '\uf109'},
                LOAD_BALANCER: {
                    icon: 'fa fa-random',
            ...
            "SEVERITY": {
                ...
                NONE: {icon: 'fa fa-ban', color: 'default', title: 'Yok'}
            },
            "ALARMTYPE": {
                ALARM: 'Alarm',
                EVENT: 'Alarm Olay'
            ...
            "NODETYPE": {
                ...
                EDR: "EDR Sistemi",
                SDNIP: "BGP Ayarları",
                NFV_ADAPTER :"NFV Adaptörü",
                DHCP_CENTRAL_WAN : "Merkezi DHCP Sistemi",
                SFC : "SFZ Sistemi"
            },
            "CONFIGVALUETYPE": {
                STRING: "Metin",
            ...
            "SWITCHSTATUS": {
                DOWN: {icon: 'fa fa-minus-circle', color: 'red-soft', title: 'Çalışmıyor'},
                UP: {icon: 'fa fa-check-circle', color: 'green-jungle', title: 'Çalışıyor'},
                "false": {icon: 'fa fa-minus', color: 'grey-steel', title: 'Tanımsız'},
                POWER_SAVER: {icon: 'fa fa-battery-quarter', color: 'font-yellow-gold', title: 'Güç Tasarrufu'}
            },
            "SWITCHMODE": {
                PASSIVE: {icon: 'fa fa-minus-circle', color: 'red-soft', title: 'Pasif'},
                ACTIVE: {icon: 'fa fa-check-circle', color: 'green-jungle', title: 'Aktif'},
                SLAVE: {icon: 'fa fa-circle-o', color: 'font-red-sunglo', title: 'Köle'},
                BACKUP: {icon: 'fa fa-random', color: 'purple', title: 'Yedek'},
                MAINTANENCE: {icon: 'fa fa-exclamation-triangle', color: 'font-yellow-gold', title: 'Bakım'},
                "false": {icon: 'fa fa-minus', color: 'grey-steel', title: 'Tanımsız'}
            },
            "OFFLINEMODE": {
                "SECURE": "Güvenli",
            ...
            "WANPORTINFOSTATUS": {
                UP: {icon: 'fa fa-check-circle', color: 'green-jungle', title: 'Çalışıyor'},
                DOWN: {icon: 'fa fa-minus-circle', color: 'red-soft', title: 'Çalışmıyor'},
                DISABLED: {icon: 'fa fa-ban', color: 'red-mint', title: 'Devre Dışı'}
            },
        ...
        "network_vis": {
            ...
            "topology": {
                ...
                "node_properties": {
                    ...
                    "zoom_in": "Yakınlaştır",
                    "zoom_out": "Uzaklaştır",
                    "create_and_send_vtn": "Kontrole Yolla",
                    "approve": "Onayla",
                    "reject": "Reddet",
                    "select": "Birim Seç",
                    ...
                    "labels": {
                        ...
                        "stat_fields": {
                            "bandwidth": {title: "Bant Genişliği", icon: "fa fa-road"},
                            "utilization": {title: "Kullanım Oranı(Yük)", icon: "fa fa-pie-chart"},
                ...
                "path_actions": {
	                ...
	                "toggle_graph": {title: "Grafikleri göster", icon: "icon-graph icon_sub icon_sub-eye"},
                },
                ...
                "messages": {
                    ...
                    "path_created_error_status": "Patika Oluşturulamadı. Lütfen statüsü kontrol edin. (NONE)",
                    ...
                    "to_ap": "Ağ Cihazı Olarak Düzenle",
	                "show_graph": "Grafik Göster",
                    "to_vnf": "VNF'e dönüştür",
                    "quarantine": "Karantinaya al",
                    "no_quarantine": "Karantinayı kaldır",
                    "confirm_quarantine": "{{name}} adlı Uç birimi karantinaya almak istediğinize emin misiniz?",
                    "confirm_no_quarantine": "{{name}} adlı Uç birimi karantinadan çıkarmak istediğinize emin misiniz?",
            ...
            "switch": {
                ...
                "port_list": {
                    ...
                    "badges": {
                        "blocked": { badge:"BL", title: "Bloklanmış", color:"badge-default" },
                        "link_down": { badge:"BK", title: "Bağlantı Kopuk", color:"badge-danger" },
                        "live": { badge:"CN", title: "Canlı", color:"badge-success" },
                        "stp_active": { badge:"SA", title: "STP Aktif", color:"badge-info" },
                        "port_down": { badge:"KB", title: "Kapalı Bağlantı Noktası", color:"badge-danger" },
                        "no_fwd": { badge:"YY", title: "Yönlendirme yok", color:"badge-primary" },
                        "no_packet_in": { badge:"PY", title: "Paket Alımı yok", color:"badge-primary" },
                        "no_recv": { badge:"AY", title: "Alım yok", color:"badge-primary" }
                    }
                },
            },
            "host": "Uç Birim",
            ...
            "controller_management": {
                ...
                "controllerSettings": {
                    ...
                    "controller": {
                        "icon": "fa fa-gavel",
                        "title": "Kontrolcü Detayları",
                        "basePerm": "cluster",
                        "perm": "#view",
                        "fields": {
                            "id": "Kontrolcü Kimlik No",
                            "clusterId":"Küme No",
                            "name": "Kontrolcü Adı",
                            "ip": "IP Adresi",
                            "port": "Port",
                ...
                "switchSettings": {
                    ...
                    "edit": {
                        ...
                        "fields": {
                            ...
                            "ncName": "İsim",
                            "ncPassword": "Şifre",
	                        "usingControlChannel" : "Kontrol Kanalını Kullanabilir"
                        },
                        "messages": {
        ...
        "policy_management": {
            ...
            "service_quality": {
                "list": {
                    ...
                    "badges" : {
                        "dhspMark": { badge:"Dİ", title: "DSCP İşaretleme"},
                        "IP": { badge:"IP", title: "IP Başlık Değiştirme"},
                        "vlanId": { badge:"VE", title: "VLAN Etiketleme"},
                        "routingServices": { badge:"Pİ", title: "Patika İşlemleri"},
                        "reservedPath": { badge:"PR", title: "Patika Rezervasyon"},
                        "ntopRoute": { badge:"EK", title: "NTOP Erişim Kontrol"},
                    }
                },
                "create": {},
                "edit": {
                ...
                "edit": {
                    ...
                    "fields": {
                        "priority": {
                            "label": "Öncelik",
                            "placeholder": "--seçiniz--",
                            "help_line": "1-7 arası değer alır. Yüksek numaralı patikanın diğerlerine göre önceliği vardır.",
                            "help_block": ""
                        },
                        "topology": {
                            "label": "Ağ"
                ...
                "search": {
                    ...
                    "resultPart": {
                        ...
                        "buttons": {
                            ...
                            "editNacGroup": "Erişim Grubu Düzenle",
        ...
        "network_function_virtualization": {
            ...
            "network_service_record": {
                ...
                "edit": {
                    ...
                    "modes": {
                        "edit": {
                            "title": "Ağ Servis Kaydını Düzenle",
                            "icon": "fa fa-pencil",
                            "perm": "#edit",
                        },
                        "create": {
                            "title": "Ağ Servis Kaydı Ekle",
                            "icon": "fa fa-plus",
                            "perm": "#create",
                        }
                    },
                    ...
                    "messages": {
                        "save_success": "'{{dto.name}}' isimli Ağ Servis Kaydı başarıyla güncellenmiştir.",
                        "create_success": "'{{dto.name}}' isimli Ağ Servis Kaydı başarıyla oluşturulmuştur.",
                        "create_not_allowed":"Yeni NAğ Servis Kaydı bu ekrandan oluşturulamaz.",
                    }
                }
            },
                ...
                "list": {
                    ...
                    "actions": {
                        ...
                        "restart":{
	                        ...
	                        "title_short": "Yeniden Başlat",
	                        "icon": "fa fa-refresh",
	                        "color": "btn-outline uppercase yellow",
	                        "perm": "#view",
                        },
	                    "restart_hard":{
		                    "title": "Yeniden Başlat(Hard)",
		                    "title_short": "Yeniden Başlat(Hard)",
		                    "icon": "fa fa-refresh",
		                    "color": "btn-outline uppercase red",
		                    "perm": "#view",
	                    },
	                    "restart_soft":{
		                    "title": "Yeniden Başlat(Soft)",
		                    "title_short": "Yeniden Başlat(Soft)",
		                    "icon": "fa fa-refresh",
		                    "color": "btn-outline uppercase purple",
		                    "perm": "#view",
	                    },
                        "delete": {
                    ...
                    "messages": {
	                    ...
	                    "restart_confirm" : "Yeniden başlatmak istediğinize emin misiniz?",
	                    "restart_success" : "Yeniden başlatıldı"
                    }
                },
                "edit": {
                    "basePerm": "nfva_nsr",
	        ...
	        "statistics" : {
		        "title": "Compute Host İstatistikleri",
		        "icon": "fa fa-bar-chart",
		        "basePerm": "nfva_nsr",
		        "perm": "#list",
		        "fields":{
		        	"VIM" : "VIM",
			        "memory" : "Boş/Kullanılan/Toplam Hafıza",
			        "disk" : "Boş Disk/ Kullanılabilir Disk",
			        "localgb" : "Yerel  Kullanılan(GB)/Toplam",
			        "computeHostIp" : "Host IP",
			        "runningTime" : "Çalışma Süresi",
			        "pastLoad" : "Geçmiş Yük 1Dk/5Dk/15Dk",
			        "loggedUsers" : "Kayıtlı Kullanıcı",
			        "currentNodeTime" : "Node Süresi",
			        "vcpus" : "VCPUS",
			        "runningVms" : "VMS"
		        }
	        }
            ...
            "dhcp": {
                ...
                "edit": {
                    ...
                    "range": {
                        ...
                        "reservedAddresses": "MAC Rezerve",
                        "reservedUserAddresses": "Kullanıcı Rezerve",
                    ...
                    "messages": {
                        ...
                        "create_success_reservedAddress": "'{{dto.mac}}' MAC adres rezervasyonu başarıyla oluşturulmuştur.",
                        "delete_success_reservedAddress": "'{{dto.mac}}' MAC adres rezervasyonu başarıyla silinmiştir.",
                        "create_success_reservedUserAddress": "'{{dto.username}}' kullanıcı rezervasyonu başarıyla oluşturulmuştur.",
                        "delete_success_reservedUserAddress": "'{{dto.username}}' kullanıcı rezervasyonu başarıyla silinmiştir.",
                        ...
                        "user_not_found":"Son kullanıcı bulunamadı, lütfen yazımı kontrol ediniz."
                    },
                    "scope": {
                        "name": "Alan Adı",
                        "ipVersionType": "IP Sürümü",
        ...
        "statistics": {
            ...
            "dashboard": {
                ...
                "popups":{
                	"switch" : {
                		"title" : "Anahtarlayıcı İstatistikleri",
                ...
                "metrics": {
                    "portstat": {
                        "bytesReceived": "Alınan Veri Miktarı",
                        "bytesSent": "Gönderilen Veri Miktarı",
                        "collisions": "Çakışmalar",
                        "errorRate": "Hata Oranları",
                        "packetsReceived": "Alınan Paketler",
                        "packetsRxDropped": "Kaybedilen Rx Paketler",
                        "packetsRxErrors": "Hatalı Rx Paketler",
                        "packetsSent": "Gönderilen Paketler",
                        "packetsTxDropped": "Kaybedilen Tx Paketler",
	                ...
	                "hoststat":{
                    	"receiveByteCount" : "Alınan Bayt Sayısı",
		                "sendByteCount" : "Gönderilen Bayt Sayısı"
	                },
	                "df" : {
						"bytes" : {
							"free" : "Boş Disk",
							"percentused" : "Kullanılan Yüzde",
							"used" : "Kullanılan Disk"
						}
	                },
	                "groupstat" : {
                    	"bytes": "Veri Miktarı",
		                "life" : "Yaşam Süresi",
		                "packets" : "Grup Paketleri"
	                },
	                "queuestat" : {
		                "bytes": "Veri Miktarı",
		                "life" : "Yaşam Süresi",
		                "packets" : "Sıra Paketler"
	                },
	                "misc-stats" : {
                    	"flow" : {
                    		"count" : "Akış Sayısı"
	                ...
	                "iostat" : {
                    	"disk" : {
                    		"msec_read" : "Disk Okuma Süresi",
		                    "msec_write" : "Disk Yazma Süresi",
                            "write_requests" : "Disk Yazma İsteği",
                            "msec_weighted_total" : "Ortalama İşlem Süresi"
	                    }
	                },
	                "sys":{
                    	"cpu":{
		                    "nice" : "İşlemci Bekleme",
		                    "user" : "Kaynak Kullanıcısı",
		                    "iowait": "İşlemci Bekleme"
	                    }
	                }
                },
                "units": {
                ...
                "filter": {
                    "mvtn": "Sanal Ağ",
                    "devices": "Anahtarlayıcı",
	                "device": "Anahtarlayıcı",
                    "metrics": "Ölçer",
                    "ports": "Port",
                    "duration": "Süre",
                    "hosts": "Cihaz",
	                "host": "Cihaz",
	                "fstype": "Dosya Sistem Tipi",
	                "tables" : "Tablo",
	                "user" : "Kullanıcı",
	                "mount" : "Mount",
                    "devs" : "Disk",
        ...
        "statistic_metrics":{
	        ...
	        "df": {
	        	"bytes" : {
	        		"percentused" : "Kullanılan Bayt Oranı"
		        }
	        },
	        "flow":{
        		"count" : "Akış Miktarı"
        ...
        "alarms": {
            ...
            "list": {
                ...
                "actions": {
                    ...
                    "controller": {
                        "title": "Kontrolcüyü Kapa",
                        "title_short": "Kontrolcüyü Kapa",
                        "icon": "fa fa-stop",
                        "color": "red-sunglo",
                ...
                "messages": {
                    "emergency": "'{{dto.vtnName}}' isimli Acil Durum Senaryosu oluşmuştur. Politika aksiyonlarını başlatmak ister misiniz?",
                    "emergency_confirm": "Politika Aksiyonları uygulanmaktadır.",
                    "emergency_deny": "Politika Aksiyonları uygulanmayacaktır.",
                    "controller": "'{{dto.sourceInstance}}' isimli Kontrolcü uzun süredir kullanılmamaktadır. Kontrolcüyü kapatmak ister misiniz?",
                    "controller_confirm": "Kontrolcü başarıyla kapatılmıştır."
                }
            },
            "notify": {
                "title": "Alarmlar",
        ...
        "alarm_logs": {
            ...
            "list": {
                ...
                "fields": {
	                ...
	                "correctionAction" : "Düzeltme Aksiyonu"
                },
                "messages": {
                    "select_item": "Lütfen detaylar için listeden bir günlük kaydı seçiniz. "
                },
        ...
        "wlan": {
            ...
            "edit": {
                ...
                "messages": {
                    "save_success": "'{{dto.name}}' isimli WLAN başarıyla güncellenmiştir.",
                    "create_success": "'{{dto.name}}' isimli WLAN başarıyla oluşturulmuştur.",
                },
                "labels": {}
            }
        },
        "wan_vtn_management": {
            ...
            "messages": {
                "delete_confirm": "'{{dto.name}}' isimli WANı silmek istediğinize emin misiniz?",
                "delete_success": "'{{dto.name}}' isimli WAN başarıyla silinmiştir!"
            }
        },
        "bgp_management": {
            "title": "BGP Yönetimi",
            ...
            "peer": {
                ...
                "edit": {
                    ...
                    "messages": {
                    	"save_success" : "'{{dto.speaker.name}}' sözcüsünün komşuluğu başarıyla güncellenmiştir.",
	                    "create_success" : "'{{dto.speaker.name}}' sözcüsünün komşuluğu başarıyla oluşturulmuştur."
                    },
                    "name": "Adı",
                    "asNumber": "Otonom No",
                    "ip": "IP Blok",
