export var en_resources = {
    "translation": {
        ...
        "enums": {
            ...
            "NACDEVICESTATUS": {
                ACTIVE: {icon: 'fa fa-check-circle', color: 'green-jungle', title: 'Active'},
                QUARANTINED: {icon: 'fa fa-medkit', color: 'red-mint', title: 'Quarantined'}
            },
            "NACENTITYTYPE": {
            ...
            "SWITCHSTATUS": {
                ...
                "false": {icon: 'fa fa-minus', color: 'grey-steel', title: 'None'},
                POWER_SAVER: {icon: 'fa fa-battery-quarter', color: 'font-yellow-gold', title: 'Power Saver'}
            },
            "SWITCHMODE": {
                PASSIVE: {icon: 'fa fa-minus-circle', color: 'red-soft', title: 'Passive'},
                ACTIVE: {icon: 'fa fa-check-circle', color: 'green-jungle', title: 'Active'},
                SLAVE: {icon: 'fa fa-circle-o', color: 'font-red-sunglo', title: 'Slave'},
                BACKUP: {icon: 'fa fa-random', color: 'purple', title: 'Backup'},
                MAINTANENCE: {icon: 'fa fa-exclamation-triangle', color: 'font-yellow-gold', title: 'Maintanence'},
                "false": {icon: 'fa fa-minus', color: 'grey-steel', title: '-'}
            },
            "OFFLINEMODE": {
                "SECURE": "Secure",
        ...
        "network_vis": {
            ...
            "topology": {
                ...
                "node_properties": {
                    ...
                    "zoom_in": "Zoom in",
                    "zoom_out": "Zoom out",
                    "create_and_send_vtn": "Check Validity",
                    "approve": "Approve",
                    "reject": "Reject",
                ...
                "path_actions": {
	                ...
	                "toggle_graph": {title: "Toggle Graphs", icon: "icon-graph icon_sub icon_sub-eye"},
                },
                ...
                "messages": {
                    ...
                    "path_created_error_status": "Failed to create the Path. Please check the path status (NONE)",
                    ...
                    "to_ap": "Convert To Network Device",
	                "show_graph": "Show Graph",
                    "to_vnf": "Convert to VNF",
                    "quarantine": "Quarantine",
                    "no_quarantine": "Remove Quarantine",
                    "confirm_quarantine": "Do you really want to quarantine {{name}} Host?",
                    "confirm_no_quarantine": "Do you really want to remove the quarantine from {{name}} Host?",
            ...
            "switch": {
                ...
                "port_list": {
                    ...
                    "badges": {
                        "blocked": { badge:"BL", title: "Blocked", color:"badge-default" },
                        "link_down": { badge:"LD", title: "Link Down", color:"badge-danger" },
                        "live": { badge:"LV", title: "Live", color:"badge-success" },
                        "stp_active": { badge:"SA", title: "STP Active", color:"badge-info" },
                        "port_down": { badge:"PD", title: "Port Down", color:"badge-danger" },
                        "no_fwd": { badge:"NF", title: "No Forwarding", color:"badge-primary" },
                        "no_packet_in": { badge:"NP", title: "No Packet In", color:"badge-primary" },
                        "no_recv": { badge:"NR", title: "No Receive", color:"badge-primary" }
                    }
                },
            },
            "host": "Host",
                ...
                "switchSettings": {
                    ...
                    "edit": {
                        ...
                        "fields": {
                            ...
                            "ncName": "Name",
                            "ncPassword": "Password",
	                        "usingControlChannel" : "Can Use Controller Channel"
                        },
                        "messages": {
        ...
        "policy_management": {
            ...
            "service_quality": {
                "list": {
                    ...
                    "badges" : {
                        "dhspMark": { badge:"DM", title: "DHSP Marking"},
                        "IP": { badge:"IP", title: "Change IP Headers"},
                        "vlanId": { badge:"VT", title: "VLAN Tagging"},
                        "routingServices": { badge:"RS", title: "Routing Services"},
                        "reservedPath": { badge:"PR", title: "Path Reservation"},
                        "ntopRoute": { badge:"AC", title: "Access Control via NTOP"},
                    }
                },
                "create": {},
                "edit": {
                ...
                "edit": {
                    ...
                    "fields": {
                        "priority": {
                            "label": "Priority",
                            "placeholder": "--select--",
                            "help_line": "A value between 1-7. Path with the higher priority has priority over other paths.",
                            "help_block": ""
                        },
                        "topology": {
                            "label": "Topology"
        ...
        "network_function_virtualization": {
            ...
            "network_service_record": {
                ...
                "edit": {
                    ...
                    "modes": {
                        "edit": {
                            "title": "Edit Network Service Record",
                            "icon": "fa fa-pencil",
                            "perm": "#edit",
                        },
                        "create": {
                            "title": "Create Network Service Record",
                            "icon": "fa fa-plus",
                            "perm": "#create",
                        }
                    },
                    ...
                    "messages": {
                        "save_success": "Network Service Record '{{dto.name}}' is updated successfully",
                        "create_success": "Network Service Record '{{dto.name}}' is created successfully",
                        "create_not_allowed":"New Network Service Record creation is not allowed from this screen.",
                    }
                }
            },
            "virtual_network_function": {
                "list": {
                    ...
                    "actions": {
                        ...
                        "view": {
                            "title": "Virtual Network Function Details",
                            "title_short": "Details",
                            "icon": "fa fa-eye",
                            "color": "blue",
                            "perm": "#view",
            ...
            "vnf_instance": {
                "list": {
                    ...
                    "messages": {
	                    ...
	                    "restart_confirm" : "Do you want to restart?",
	                    "restart_success" : "VNF instance has been restarted successfully"
                    }
                },
                "edit": {
                    "basePerm": "nfva_nsr",
	        ...
	        "statistics" : {
		        ...
		        "fields":{
			        ...
			        "disk" : "Free / Available Disc",
			        "localgb" : "Local Used(GB)/Total",
			        "computeHostIp" : "Host IP",
			        "runningTime" : "Runtime",
			        "pastLoad" : "Past Load 1min/5min/15min",
			        "loggedUsers" : "Logged Users",
			        "currentNodeTime" : "Current Node Time",
			        "vcpus" : "VCPUS",
			        "runningVms" : "VMS"
		        }
	        }
            ...
            "dhcp": {
                ...
                "edit": {
                    ...
                    "range": {
                        ...
                        "reservedAddresses": "MAC Reserved",
                        "reservedUserAddresses": "User Reserved",
                    ...
                    "messages": {
                        ...
                        "create_success_reservedAddress": "Reservation for Mac address '{{dto.mac}}' created successfully.",
                        "delete_success_reservedAddress": "Reservation for Mac address '{{dto.mac}}' removed successfully.",
                        "create_success_reservedUserAddress": "Reservation for User '{{dto.username}}' created successfully.",
                        "delete_success_reservedUserAddress": "Reservation for User '{{dto.username}}' removed successfully.",
                        ...
                        "user_not_found":"NAC user not found, please check your typing."
                    },
                    "scope": {
                        "name": "Field Name",
                        "ipVersionType": "IP Version",
        ...
        "statistics": {
            ...
            "dashboard": {
                ...
                "metrics": {
	                ...
	                "hoststat":{
		                "receiveByteCount" : "Receive Byte",
		                "sendByteCount" : "Send Byte"
	                },
	                "df" : {
		                "bytes" : {
			                "free" : "Free",
	                ...
	                "iostat" : {
		                "disk" : {
			                "msec_read" : "Read",
			                "msec_write" : "Write",
                            "write_requests" : "Write Request",
                            "msec_weighted_total" : "Weighted Total"
		                }
	                },
	                "sys":{
		                "cpu":{
	    ...
	    "statistic_metrics":{
		    "undefined": "",
		    "portstat": {
			    "bytesReceived": "Bytes Recieved",
			    "bytesSent": "Bytes Sent",
			    "collisions": "Collissions",
			    "errorRate": "Error Rates",
			    "packetsReceived": "Packets Recieved",
			    "packetsRxDropped": "Packets Rx Dropped",
			    "packetsRxErrors": "Packets Rx Errors",
			    "packetsSent": "Packets Sent",
			    "packetsTxDropped": "Packets Tx Dropped",
			    "packetsTxErrors": "Hatalı Packets Tx Errors",
			    "receiveRate": "Receive Rate",
			    "sendRate": "Send Rate"
		    },
		    "meterstat": {
        ...
        "bgp_management": {
            ...
            "peer": {
                ...
                "edit": {
                    ...
                    "messages": {
                    	"save_success" : "Peer of the speaker '{{dto.speaker.name}}' has been successfully updated.",
	                    "create_success" : "Peer of the speaker '{{dto.speaker.name}}' has been successfully created"
                    },
                    "name": "Adı",
                    "asNumber": "Otonom No",
                    "ip": "IP Blok",
