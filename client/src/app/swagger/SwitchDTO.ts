...
export interface SwitchDTO extends BaseDTO {
    ...
    */
    ...
    /**
    * Anahtarlayıcının zenginleştirilmiş ID'si
    */
    enrichedDeviceId?: string;
    ...
    */
    ...
    /**
    * Anahtarlayıcının Kontrol kanalını kullanıp kullanamadığını söyler.
    */
    usingControlChannel?: boolean;
...
export var SwitchDTODef:IModelDef = {
    ...
    fields: $.extend({}, BaseDTODef.fields,  {
        ...
        supports : { type: SupportInfoDef }, 

        powerSaverModeEnabled : { type: 'boolean' }, 

        deviceType : { type: 'string' }, 

        slaveControllerIds : { type: 'Array' }, 
        ...
        usingControlChannel : { type: 'boolean' }, 
