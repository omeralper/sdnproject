...
export interface DhcpIpRangeDTO extends BaseDTO {
    ...
    */
    ...
    /**
    * Dhcp ip menzili (DhcpIpRange) içinde yeralan belirli kullanıcı-ip adresi çiftleri için ayrılmış ip adreslerinin listesidir.
    */
    ipsReservedUserDtos?: Array<DhcpIpReservedUserDTO>;
...
export var DhcpIpRangeDTODef:IModelDef = {
    ...
    fields: $.extend({}, BaseDTODef.fields,  {
        ...
        ipsReservedUserDtos : { type: 'Array' }, 
