...
@Component({
    moduleId: module.id,
    selector: 'commons-alarm-notification-component',
    templateUrl: './notification.component.html',
    styleUrls: ['./notification.component.css']
})
export class AlarmNotificationComponent extends NotificationComponent<AlarmDTO> implements OnDestroy {
    ...
    constructor(public eventsManager: EventsManager,
        ...
        this.logger.info("AlarmNotificationComponent Initialized");

        this.titleKey = "alarms.notify.title";
        this.itemCountKey = "alarms.notify.labels.alarm_count";
        this.viewAllKey = "alarms.notify.labels.view_all";
        this.iconClass = "fa fa-bell";
        this.buttonClass = "btn-group-red";
    ...
    public subscribeToAlarmEvents() {
        this.unSubscribeFromAlarmEvents();
        this.alarmEventSubscription = this.eventsManager.on<AlarmEvent>(ALARM_SYSTEM.ALARM, (event) => {
