var Layout = function () {
    var o = "layouts/layout5/img/", n = "layouts/layout5/css/", e = App.getResponsiveBreakpoint("md"), a = function () {
        ...
        $(".page-header .navbar-nav > .dropdown-fw, .page-header .navbar-nav > .more-dropdown, .page-header .navbar-nav > .dropdown > .dropdown-menu  > .dropdown").click(function (o) {
            ...
            if (App.getViewPort().width < e)$(this).hasClass("open") ? n.removeClass("open") : (n.removeClass("open"), $(this).addClass("open"), App.scrollTo($(this))); else {
        ...
        var o = App.getViewPort().width, n = $(".page-header .navbar-nav");
